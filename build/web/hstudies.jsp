...
ResultSet rs=stat.executeQuery("select * from phstudies where Id='"+Id+"'");
if(rs.next())
{
%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<title>Club Information</title>
        ...
        <link rel='stylesheet' type='text/css' href='hstudies.css'/>
    ...
    <body>
        ...
        <div id="mid_float">
            <div id="infodiv">
           <form action="UpdateDatahstudies" method="post" autocomplete="off">
           <table id="tableid" width="500" height="150">
            <caption><h3>Higher Studies Information</h3></caption>
                <td></td>
            <tr>
                <td width="300" height="42">Name of Institution</td>
                <td width="300" height="42"><input type="text" name="Name" value="<%=rs.getString(2) %>"></td>
            </tr>
            <tr>
                <td width="300" height="42">Country</td>
               <td width="300" height="42"><input type="text" name="Country" value="<%=rs.getString(3) %>"></td>
            </tr>
            <tr>
                <td width="300" height="50">Date of joining</td>
                <td width="300" height="50">
                    <div class="input-group date" data-provide="datepicker">
                    <input type="text" class="form-control" autocomplete="off" name="StartDate" value="<%=rs.getString(4)%>">
          ...
          <br>
            <table id="tableid1" width="500" height="50">
                <tr>
                <form action="UpdateFilehstudies" enctype="multipart/form-data"  method="post" onSubmit="return validation(this)">
        ...
        <script type="text/javascript">
            var Msg ='<%=session.getAttribute("getAlerthstudies")%>';
            if (Msg != "null")
            {
                function alertName()
                {
        ...
        <script type="text/javascript"> window.onload = alertName; <%session.setAttribute("getAlerthstudies", "null"); %></script>
    </body>
</html>   
<%
}
